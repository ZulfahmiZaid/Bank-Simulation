...
/**
 * Eine Klasse, die Sendung der Geldmenge darstellen
 */
public class OutgoingTransfer extends Transfer{
     ...
     */
    public OutgoingTransfer(String input_date, double input_amount, String input_description) throws TransactionAttributeException {
     ...
     */
    public OutgoingTransfer(String input_date, double input_amount, String input_description, String input_sender, String input_recipient) throws TransactionAttributeException  {
     ...
     * @param outgoing_copy zukopierendes Objekt von der Klasse OutgoingTransfer
     */
    public OutgoingTransfer (OutgoingTransfer outgoing_copy) throws TransactionAttributeException  {
        super(outgoing_copy);
    }
    /**
     * Bill berechnen
